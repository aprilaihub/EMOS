// Auto-generated IU Feature for predictor: chgnet
class ChgnetIUFeature extends BaseFeature {
    constructor(featureId, iuMeta = {}) {
        super(
            featureId,
            iuMeta.iuName ? `${iuMeta.iuName} IU Feature` : 'CHGNet IU Feature',
            iuMeta.iuDesc || 'Charge-informed graph neural network potential for energy, force, stress, and relaxation prediction'
        );
        this.iuType = iuMeta.iuType || 'predictor';
        this.iuId = iuMeta.iuId || 'chgnet';
...
window.ChgnetIUFeature = ChgnetIUFeature;
