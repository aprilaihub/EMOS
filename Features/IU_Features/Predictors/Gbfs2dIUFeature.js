// Auto-generated IU Feature for predictor: gbfs_2d
class Gbfs2dIUFeature extends BaseFeature {
    constructor(featureId, iuMeta = {}) {
        super(
            featureId,
            iuMeta.iuName ? `${iuMeta.iuName} IU Feature` : 'GBFS-2D IU Feature',
            iuMeta.iuDesc || 'Pretrained GBFS workflow predictors specialized for 2D layered materials'
        );
        this.iuType = iuMeta.iuType || 'predictor';
        this.iuId = iuMeta.iuId || 'gbfs_2d';
...
window.Gbfs2dIUFeature = Gbfs2dIUFeature;
