// Auto-generated IU Feature for predictor: gbfs
class GbfsIUFeature extends BaseFeature {
    constructor(featureId, iuMeta = {}) {
        super(
            featureId,
            iuMeta.iuName ? `${iuMeta.iuName} IU Feature` : 'GBFS IU Feature',
            iuMeta.iuDesc || 'Pretrained predictors from GBFS workflow, implemented in Python'
        );
        this.iuType = iuMeta.iuType || 'predictor';
        this.iuId = iuMeta.iuId || 'gbfs';
...
window.GbfsIUFeature = GbfsIUFeature;
