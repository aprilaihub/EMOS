// Auto-generated IU Feature for predictor: synthnn
class SynthnnIUFeature extends BaseFeature {
    constructor(featureId, iuMeta = {}) {
        super(
            featureId,
            iuMeta.iuName ? `${iuMeta.iuName} IU Feature` : 'SynthNN IU Feature',
            iuMeta.iuDesc || 'Synthesis Neural Network for synthesizability prediction'
        );
        this.iuType = iuMeta.iuType || 'predictor';
        this.iuId = iuMeta.iuId || 'synthnn';
...
window.SynthnnIUFeature = SynthnnIUFeature;
