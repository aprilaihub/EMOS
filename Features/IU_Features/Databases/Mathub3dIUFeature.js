// Auto-generated IU Feature for database: mathub3d
class Mathub3dIUFeature extends BaseFeature {
    constructor(featureId, iuMeta = {}) {
        super(
            featureId,
            iuMeta.iuName ? `${iuMeta.iuName} IU Feature` : 'Mathub3d IU Feature',
            iuMeta.iuDesc || 'MatHub-3d - first-principles materials repository with 3D structures for high-throughput thermoelectric research'
        );
        this.iuType = iuMeta.iuType || 'database';
        this.iuId = iuMeta.iuId || 'mathub3d';
...
window.Mathub3dIUFeature = Mathub3dIUFeature;
