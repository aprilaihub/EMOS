// Auto-generated IU Feature for database: materialsproject
class MaterialsprojectIUFeature extends BaseFeature {
    constructor(featureId, iuMeta = {}) {
        super(
            featureId,
            iuMeta.iuName ? `${iuMeta.iuName} IU Feature` : 'MaterialsProject IU Feature',
            iuMeta.iuDesc || 'Materials Project - computational materials database'
        );
        this.iuType = iuMeta.iuType || 'database';
        this.iuId = iuMeta.iuId || 'materialsproject';
...
window.MaterialsprojectIUFeature = MaterialsprojectIUFeature;
