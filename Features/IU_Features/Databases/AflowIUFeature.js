// Auto-generated IU Feature for database: aflow
class AflowIUFeature extends BaseFeature {
    constructor(featureId, iuMeta = {}) {
        super(
            featureId,
            iuMeta.iuName ? `${iuMeta.iuName} IU Feature` : 'AFLOW IU Feature',
            iuMeta.iuDesc || 'AFLOW - Automatic FLOW database for computational materials science with rich mechanical, thermal, and electronic properties'
        );
        this.iuType = iuMeta.iuType || 'database';
        this.iuId = iuMeta.iuId || 'aflow';
...
window.AflowIUFeature = AflowIUFeature;
