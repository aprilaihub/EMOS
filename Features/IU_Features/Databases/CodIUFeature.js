// Auto-generated IU Feature for database: cod
class CodIUFeature extends BaseFeature {
    constructor(featureId, iuMeta = {}) {
        super(
            featureId,
            iuMeta.iuName ? `${iuMeta.iuName} IU Feature` : 'COD IU Feature',
            iuMeta.iuDesc || 'Crystallography Open Database - open-access collection of crystal structures'
        );
        this.iuType = iuMeta.iuType || 'database';
        this.iuId = iuMeta.iuId || 'cod';
...
window.CodIUFeature = CodIUFeature;
