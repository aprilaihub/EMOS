// Auto-generated IU Feature for database: jarvisdft
class JarvisdftIUFeature extends BaseFeature {
    constructor(featureId, iuMeta = {}) {
        super(
            featureId,
            iuMeta.iuName ? `${iuMeta.iuName} IU Feature` : 'JarvisDFT IU Feature',
            iuMeta.iuDesc || 'JARVIS-DFT - NIST computational materials database with electronic, optical, and solar cell properties'
        );
        this.iuType = iuMeta.iuType || 'database';
        this.iuId = iuMeta.iuId || 'jarvisdft';
...
window.JarvisdftIUFeature = JarvisdftIUFeature;
