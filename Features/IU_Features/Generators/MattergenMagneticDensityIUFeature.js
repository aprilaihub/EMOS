// Auto-generated IU Feature for generator: mattergen_magnetic_density
class MattergenMagneticDensityIUFeature extends BaseFeature {
    constructor(featureId, iuMeta = {}) {
        super(
            featureId,
            iuMeta.iuName ? `${iuMeta.iuName} IU Feature` : 'MatterGen: Magnetic Density IU Feature',
            iuMeta.iuDesc || 'Property-conditioned model for generating structures with a target DFT magnetic density (dft_mag_density)'
        );
        this.iuType = iuMeta.iuType || 'generator';
        this.iuId = iuMeta.iuId || 'mattergen_magnetic_density';
...
window.MattergenMagneticDensityIUFeature = MattergenMagneticDensityIUFeature;
