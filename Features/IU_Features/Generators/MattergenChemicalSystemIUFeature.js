// Auto-generated IU Feature for generator: mattergen_chemical_system
class MattergenChemicalSystemIUFeature extends BaseFeature {
    constructor(featureId, iuMeta = {}) {
        super(
            featureId,
            iuMeta.iuName ? `${iuMeta.iuName} IU Feature` : 'MatterGen: Chemical System IU Feature',
            iuMeta.iuDesc || 'Conditional model for generating structures within a specified chemical system (chemical_system)'
        );
        this.iuType = iuMeta.iuType || 'generator';
        this.iuId = iuMeta.iuId || 'mattergen_chemical_system';
...
window.MattergenChemicalSystemIUFeature = MattergenChemicalSystemIUFeature;
