    ...
    createInputsHTML() {
        return `
            ...
            <div class="input-controls" style="max-height: 560px; overflow: auto; padding-right: 6px;">
                <p><strong>Geometry Inputs (defaults mirror wrapper)</strong></p>
                ...
                <p><strong>Mesh Inputs (defaults mirror wrapper)</strong></p>
                ...
                <p><strong>Thermal and Contact Inputs (defaults mirror wrapper)</strong></p>
                ...
                <p><strong>Doping Inputs (defaults mirror wrapper)</strong></p>
                ...
                <p><strong>Bias Sweep Inputs (defaults mirror wrapper)</strong></p>
                ...
                <p><strong>Channel Material Inputs (defaults mirror wrapper)</strong></p>
                ...
                <p><strong>Insulator Material Inputs (defaults mirror wrapper)</strong></p>
