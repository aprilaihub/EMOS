...
class MockLogger:
    ...
    def has_message(self, text):
        """Check if any logged message contains the given text."""
...
@pytest.fixture
def mock_logger():
    """Provide a mock logger that captures messages."""
    return MockLogger()
...
class MockResponse:
    ...
    def __init__(self, json_data=None, status_code=200):
        self.json_data = json_data or {"data": []}
...
@pytest.fixture
def mock_response_success(sample_fe_structure):
    """Provide a successful mock API response."""
    return MockResponse({"data": [sample_fe_structure]})


@pytest.fixture
def mock_response_empty():
    """Provide an empty mock API response."""
