...
Unconditional base model trained on the MP-20 dataset for crystal structure generation (mp_20_base)

## Overview

This module provides integration with MatterGen: MP-20 Base.
