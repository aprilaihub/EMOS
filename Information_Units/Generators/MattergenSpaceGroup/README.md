...
Symmetry-conditioned model for generating structures in a target crystallographic space group (space_group)

## Overview

This module provides integration with MatterGen: Space Group.
