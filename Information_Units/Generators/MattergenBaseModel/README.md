...
Unconditional diffusion model for general inorganic crystal structure generation (mattergen_base)

## Overview

This module provides integration with MatterGen: Base Model.
