...
Property-conditioned model for generating structures with a target DFT magnetic density (dft_mag_density)

## Overview

This module provides integration with MatterGen: Magnetic Density.
