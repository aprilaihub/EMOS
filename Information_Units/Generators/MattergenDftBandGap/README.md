...
Property-conditioned model for generating structures with a target DFT band gap (dft_band_gap)

## Overview

This module provides integration with MatterGen: DFT Band Gap.
